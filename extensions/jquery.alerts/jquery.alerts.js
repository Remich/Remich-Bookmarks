...
(function($) {
	...
	$.alerts = {
		...
		verticalOffset: -18,                // vertical offset of the dialog from center screen, in pixels
		...
		prompt_password: function(message, value, title, callback) {
			block_strg_a = 1;
			if( title == null ) title = 'Prompt';
	...
	jPromptPassword = function(message, value, title, callback) {
		$.alerts.prompt_password(message, value, title, callback);
	}
